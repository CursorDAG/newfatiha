      ...
      {activeBanners.length > 0 && (
        <div className="space-y-0">
          {activeBanners.map((banner) => {
            ...
            }[banner.color] || "bg-slate-800 text-white";
            ...
            const BannerContent = (
              <div className={`${colorClasses} py-3 px-6`}>
                <div className="max-w-7xl mx-auto flex items-center justify-center gap-3 text-sm font-medium">
                  {banner.imageUrl && (
                    <img src={banner.imageUrl} alt="" className="w-5 h-5 object-contain" />
                  )}
          ...
          <div className="max-w-6xl mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <p className="text-slate-600 text-lg max-w-2xl mx-auto">
                Преимущества обучения на платформе Fatiha.ru
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {features.map((feature) => (
                <div
                  key={feature.id}
                  className="bg-slate-50 rounded-2xl p-8 hover:shadow-lg transition-all duration-300 border border-slate-200 hover:border-emerald-300"
                >
        ...
        <section className="py-28 bg-slate-50">
          <div className="max-w-6xl mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <p className="text-slate-600 text-lg max-w-2xl mx-auto">
                Что говорят наши студенты о платформе
              </p>
            </div>
          ...
          <div className="max-w-4xl mx-auto px-6">
            ...
            <div className="space-y-4">
              {faqItems.map((item) => (
                ...
                >
                  <summary className="px-6 py-5 cursor-pointer font-bold text-slate-900 hover:bg-slate-100 transition-colors flex items-center justify-between">
