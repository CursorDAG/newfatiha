...
- [ ] Написать unit тесты для критических функций:
  - Валидация слотов расписания (`isValidSlot`, `overlaps`)
  - Логика выбора лучшего статуса квиза (`bestQuizStatusWithTimestamp`)
  - Конвертация слотов в текст (`slotsToScheduleText`)
